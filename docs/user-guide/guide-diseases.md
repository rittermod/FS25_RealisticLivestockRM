...
To keep some diseases and never see others, untick them under **Choose Diseases**, directly below the **Diseases** row: a switched-off disease starts no new cases, while animals that already have it keep it until it runs its course - see the [Settings Reference](reference-settings.md#diseases).
